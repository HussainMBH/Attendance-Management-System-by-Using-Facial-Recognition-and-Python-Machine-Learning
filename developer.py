...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"D:\Python Project\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg4.png")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Developer Pannel",font=("Bahir",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\Python Project\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\mbh.jpg")
        ...
        det_img_btn=Image.open(r"D:\Python Project\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\mbh.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Hussain",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"D:\Python Project\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\mbh.jpg")
        ...
        att_b1_1 = Button(bg_img,text="MohamedBH",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"D:\Python Project\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\mbh.png")
